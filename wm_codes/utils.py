...
#saeed
def generate_ID(ID_length, number_of_user,ecc):
    ID_tbl, ID_tbl_bit  = user_generation.generate_ID(ID_length= ID_length,n_user=number_of_user,ecc=ecc)
    return ID_tbl, ID_tbl_bit

def generate_trx(ID_tbl,n_trx=20):
    trxlist = user_generation.generate_trx(ID_tbl, n_trx)
    return trxlist
